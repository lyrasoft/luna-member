...
namespace Lyrasoft\Member\Repository;
 ...
 */
#[Repository(entityClass: Member::class)]
class MemberRepository implements ManageRepositoryInterface, ListRepositoryInterface
{
